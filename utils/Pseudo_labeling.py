...
def load_frames(video_path, 
    ...
    try:
        ...
        frame_indices     = get_index(start_sec, 
                                      end_sec, 
                                      fps, 
                                      num_segments)
...
def generate_batch_caption(pixel_values, 
                           questions, 
                           generation_config, 
                           model, 
                           tokenizer, 
...
def compute_duration_ms(scenes, 
                        total_duration, 
